...
```sh
git clone https://github.com/nickjj/docker-rails-example todo_rpg
cd todo_rpg
...
The app is named `todo_rpg` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "todo_rpg" and update a few Docker related resources.
